...
class OpusHq extends OutcomeMeasure {
  double? _score;

  double get score => _score ?? double.parse(totalScore['score']);
  late String rawData;

  OpusHq({required super.id, super.data});
  ...
  Map<String, dynamic> get totalScore {
    ...
    num scoreGroup0 =
      ...
      return e.value == null ? p : p + (4 - e.value);
    });
    num scoreGroup1 =
    ...
    num sum = scoreGroup0 + scoreGroup1 + scoreGroup2;
    score = info.scoreLookupTable!.first["$sum"].toString();
    return {'score': score};
  }

  factory OpusHq.fromJson(Map<String, dynamic> data) {
    OpusHq opusHq = OpusHq(id: ksOpusHq);
    opusHq.populateWithJson(data);
    return opusHq;
  }
  ...
  @override
  String? get templateId => ksOpusHqTemplateId;

  @override
  OpusHq clone() {
    OpusHq opusHq = OpusHq(id: ksOpusHq, data: coreDataToJson());
    return opusHq;
  }
}
